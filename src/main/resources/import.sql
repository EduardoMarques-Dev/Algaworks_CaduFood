...
insert into cozinha (id, codigo, nome) values (100, 'c3e46a1e-6dfa-470c-8037-1e3108e700fd', 'Tailandesa');
...
insert into estado (id, codigo, nome) values (100, '8fab61d5-a517-4c2b-9943-f6cb73daee3a', 'Pará');
...
insert into cidade (id, codigo, nome, estado_id) values (100, 'bd65f48f-4995-44c9-aa40-abc83d4d7599', 'Belém', 100);
...
insert into restaurante (id, codigo, nome, ativo, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, endereco_cidade_id, endereco_logradouro, endereco_numero, endereco_bairro, endereco_cep ) values ( 100, 'df5b6046-ed12-491a-9d28-177a5b8ed09c', 'Thai Gourmet', true, 10, 100, current_timestamp, current_timestamp, 100, 'Rua Quatorze A', 41, 'Maracangalha', '66110-058' );
...
insert into forma_pagamento (id, codigo, descricao) values (100, 'fb995953-5fe9-4e1b-8af5-2c48fa17ebd6', 'Cartão de crédito');
...
insert into permissao (id, codigo, nome, descricao) values ( 100, '6fdf3b94-0a76-4648-9e2c-bff35f50c49d', 'CONSULTAR_COZINHAS', 'Permite consultar cozinhas' );
...
insert into produto (codigo, nome, descricao, preco, ativo, restaurante_id) values ('698f832d-366d-46cd-bbd3-ef68ee6ace34', 'Porco com molho agridoce', 'Deliciosa carne suína ao molho especial', 78.90, true, 100);
...
insert into grupo (id, codigo, nome) values (100, '8e3ba92f-0b82-4276-856e-8ad09eda6590', 'Gerente');
...
insert into usuario (id, codigo, nome, email, senha, data_cadastro, data_atualizacao) values (100, '03dee970-f0df-4bdb-a5b1-82f36fb28ce3', 'João da Silva','joao.ger@cadufood.com', '123', current_timestamp, current_timestamp);
